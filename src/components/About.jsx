    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className={`text-center mb-16 scroll-fade-in ${isVisible ? 'visible' : ''}`}>
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4" style={{ color: '#000000' }}>
            About <span style={{ color: '#F05B28' }}>Our Clinic</span>
          </h2>
          <div className="w-24 h-1 mx-auto rounded-full" style={{ background: 'linear-gradient(to right, #F05B28, #d6491f)' }}></div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16">
          ...
          <div className={`space-y-6 scroll-fade-in-left ${isVisible ? 'visible' : ''}`}>
            <div className="space-y-4">
              <h3 className="text-3xl sm:text-4xl font-bold" style={{ color: '#000000' }}>
                Your Trusted Dental Care Partner
              </h3>
              <div className="w-16 h-1 rounded-full" style={{ backgroundColor: '#F05B28' }}></div>
            </div>
            
            <p className="text-lg text-slate-700 leading-relaxed">
              At <span className="font-semibold" style={{ color: '#F05B28' }}>Identiti Dental</span>, we've been dedicated to providing exceptional dental care for over 15 years. Our journey began with a simple mission: to create a dental practice where patients feel comfortable, valued, and receive the highest quality of care.
            </p>
          ...
          <div className={`relative scroll-fade-in-right ${isVisible ? 'visible' : ''}`}>
            <div className="relative group">
              {/* Decorative Border */}
              <div className="absolute -inset-4 rounded-2xl opacity-20 group-hover:opacity-30 blur-xl transition-opacity duration-300" style={{ background: 'linear-gradient(to right, #F05B28, #d6491f)' }}></div>
              ...
              <div className="absolute -bottom-6 -right-6 bg-white rounded-full p-4 shadow-xl transform group-hover:scale-110 transition-transform duration-300">
                <div className="flex items-center gap-2">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ background: 'linear-gradient(to bottom right, #F05B28, #d6491f)' }}>
          ...
          {highlights.map((highlight, index) => (
            ...
            >
              <div className={`${highlight.bgColor} rounded-xl p-6 h-full transform hover:scale-105 transition-all duration-300 shadow-md hover:shadow-xl border border-transparent hover:border-orange-200`}>
                ...
                <h4 className="text-2xl font-bold mb-2" style={{ color: '#000000' }}>
                  {highlight.isCounter ? (
                    <>
                      <Counter
        ...
        <div className={`rounded-2xl p-8 md:p-12 shadow-2xl scroll-fade-in ${isVisible ? 'visible' : ''}`} style={{ transitionDelay: '0.4s', background: 'linear-gradient(to right, #F05B28, #d6491f)' }}>
